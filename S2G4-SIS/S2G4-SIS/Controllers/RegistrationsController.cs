...
namespace S2G4_SIS.Controllers
{
    public class RegistrationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,CourseID,StudentID,TermID")] Registrations registrations)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,CourseID,StudentID,TermID")] Registrations registrations)
        {
            if (ModelState.IsValid)
            {
