...
namespace S2G4_SIS.Controllers
{
    public class TeachingAssignmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,CourseID,InstructorID,TermID")] TeachingAssignments teachingAssignments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,CourseID,InstructorID,TermID")] TeachingAssignments teachingAssignments)
        {
            if (ModelState.IsValid)
            {
